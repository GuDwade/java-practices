...
public class AbsoluteOrRelativePath {
    public static void main(String[] args) {
        ...
        testFile("D:\\Code\\java\\java-practices\\Java14班\\2020-4-9FilePratice\\Main.java");
        System.out.println("===========================");
        testFile("D:\\Code\\java\\Jjava-practices\\Java14班\\2020-4-9FilePratice\\NoSuchFile.java");
        System.out.println("===========================");
        testFile("E:\\Code\\java\\java-practices\\Java14班\\2020-4-9FilePratice");
        System.out.println("===========================");


        testFile("Main.java");  // 相对路径
    }
